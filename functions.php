...
function myshop_setup() {
    ...
    register_nav_menus( array( 'primary' => __( 'Primary Menu', 'myshop' ) ) );
}
...
function myshop_assets() {
    ...
    if ( file_exists( $css_file ) ) {
        wp_enqueue_style( 'myshop-main-css', $css_uri, array(), filemtime( $css_file ) );
    }
    $js_file = get_template_directory() . '/assets/js/main.js';
    $js_uri = get_template_directory_uri() . '/assets/js/main.js';
    if ( file_exists( $js_file ) ) {
        wp_enqueue_script( 'myshop-main-js', $js_uri, array('jquery'), filemtime( $js_file ), true );
    }
    wp_localize_script('myshop-main-js','myshopData',array(
        'ajax_url' => admin_url('admin-ajax.php'),
        'nonce'    => wp_create_nonce('myshop_mailchimp_nonce')
    ));
}
